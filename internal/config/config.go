...
const prBodyGeneratedByLine = "Proposed changes from Molten.Bot"
const prBodyGeneratedByLegacyLinkedLine = "[Automated change generated by Molten Hub Code.](https://molten.bot/code)"
const prBodyGeneratedByLegacyLine = "Automated change generated by Molten Hub Code."
...
func extractPRBodySummary(body string) string {
	...
	body = strings.TrimSpace(strings.ReplaceAll(body, prBodyGeneratedByLegacyLinkedLine, ""))
	body = strings.TrimSpace(strings.ReplaceAll(body, prBodyGeneratedByLegacyLine, ""))
	body = strings.TrimSpace(strings.ReplaceAll(body, "Automated change generated by MoltenHub Code.", ""))
